            ...
            <?php if ( $image_2_images ) :  ?>
                <div class="cases-dtl-col-imgs">
                    <div class="row">
                        ...
                        <?php 
                        $counter_3=1;
                        foreach ( $image_2_images as $image_2_image ): 
                        $col_class=($counter_3%2==0)?"col-2-5":"col-3";
                        ?>
...
<?php else : ?>
    <?php if ( $image_2_images ) :  ?>
        <section class="<?php echo $class; ?> <?php echo $bg_class; ?> section default-padding remove-top-padding col-33-66-sec">
