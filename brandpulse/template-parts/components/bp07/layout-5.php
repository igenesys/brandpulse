<?php 
    ...
    $image_3_images = get_sub_field( 'image_3' );
        ...
        <div class="container">
            ...
            <?php if ( $image_3_images ) :  ?>
                <div class="cases-dtl-col-imgs">
                    <div class="row">
                        <?php foreach ( $image_3_images as $image_3_image ): ?>
                            <div class="col-3">
                                <div class="case-dtl-col-img" style="background-image: url(<?php echo esc_url( $image_3_image['url'] ); ?>);">
                                    <div class="case-dtl-col-img-label">
                                        <?php if ( !empty($image_3_image['title'])) : ?>
                                            <span><img src="<?php echo get_template_directory_uri(); ?>/images/Pointer.svg" alt="" title=""/></span>
                                            <label><?php echo esc_html( $image_3_image['title'] ); ?></label>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="section-inner">
                <div class="container">
                    <div class="row">
                        <?php foreach ( $image_3_images as $image_3_image ): ?>
                            <div class="col-3">
                                <div class="cases-detail-img" style="background-image: url(<?php echo esc_url( $image_3_image['url'] ); ?>);">
                                    <img src="<?php echo esc_url( $image_3_image['url'] ); ?>" alt="<?php echo esc_attr( $image_3_image['alt'] ); ?>" title=""/>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
